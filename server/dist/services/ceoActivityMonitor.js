...
exports.ceoActivityMonitor = exports.CEOActivityMonitor = exports.DEFAULT_CEO_CONFIG = void 0;
const events_1 = require("events");
// 默认配置
exports.DEFAULT_CEO_CONFIG = {
...
class CEOActivityMonitor extends events_1.EventEmitter {
    states = new Map();
    checkInterval = null;
    config;
    constructor(config = exports.DEFAULT_CEO_CONFIG) {
        super();
        this.config = config;
     ...
     * 初始化CEO监控
     */
    startMonitoringSession(sessionId, ceoAgentId) {
        const now = Date.now();
        const state = {
            sessionId,
            lastActiveTime: now,
     ...
     * 检查特定会话的不活跃状态
     */
    checkInactivity(sessionId, state) {
     ...
     * 获取格式化的不活跃时间
     */
    getFormattedInactiveTime(sessionId) {
...
exports.CEOActivityMonitor = CEOActivityMonitor;
// 导出单例
exports.ceoActivityMonitor = new CEOActivityMonitor();
//# sourceMappingURL=ceoActivityMonitor.js.map