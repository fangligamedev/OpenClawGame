...
exports.eventEngine = exports.EventEngine = exports.RANDOM_EVENTS = void 0;
// Predefined random events
exports.RANDOM_EVENTS = [
    {
...
class EventEngine {
    ...
    triggerEvent(phase) {
        const eligibleEvents = exports.RANDOM_EVENTS.filter(e => {
...
exports.eventEngine = new EventEngine();
